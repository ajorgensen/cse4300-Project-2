/*
 *
 * This file replaces kern/main/main.c of OS161 for customization purposes
 *
 * Main.
 */
...
boot(void)
{
        ...
        kprintf("Hi, welcome to OS161! #Winning\n");
        kprintf("This version belongs to Hemal Shah. %s (%s #%d)\n", 
